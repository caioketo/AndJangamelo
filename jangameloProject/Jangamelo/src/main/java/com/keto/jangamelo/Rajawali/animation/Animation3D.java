...
import com.keto.jangamelo.Rajawali.ATransformable3D;
...
public abstract class Animation3D extends AFrameTask {
	...
	protected final List<com.keto.jangamelo.Rajawali.animation.IAnimation3DListener> mAnimationListeners;
	...
	public Animation3D() {
		mAnimationListeners = new ArrayList<com.keto.jangamelo.Rajawali.animation.IAnimation3DListener>();
	}
	 ...
	 * @return
	 */
	public boolean registerListener(com.keto.jangamelo.Rajawali.animation.IAnimation3DListener animationListener) {
		if (isPlaying())
	 ...
	 * @return {@link Boolean}
	 */
	public boolean unregisterListener(com.keto.jangamelo.Rajawali.animation.IAnimation3DListener animationListener) {
		if (isPlaying())
			throw new RuntimeException("Listeners can only be added and removed when the animation is not playing.");
